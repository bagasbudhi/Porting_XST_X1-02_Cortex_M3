...
/** @addtogroup XST_IOT_Definitions XST_IOT Definitions
  This file defines all structures and symbols for XST_IOT:
...
/******************************************************************************/
/** @addtogroup XST_IOT_CMSIS Device CMSIS Definitions
...
/******  CMSDK Specific Interrupt Numbers ********************************************************/
...
#else
  PWM1_IRQn                     = 6,       /*!< PWM 1 Interrupt                                  */
  PWM2_IRQn                     = 7,       /*!< PWM 2 Interrupt                                  */
#endif
  ...
  PORT0_15_IRQn                 = 31,
#endif
  SPI_IRQn                      = 32,      /*!< SPI Interrupt                                    */
  I2C_IRQn                      = 33,      /*!< I2C Interrupt                                    */
  TRNG_IRQn                     = 34,      /*!< TRNG Interrupt                                   */
  RTC_IRQn                      = 35,      /*!< RTC Interrupt                                    */

#ifndef XST_X1_01
  PORT0_0_IRQn                  = 40,      /*!< All P0 I/O pins can be used as interrupt source. */
  PORT0_1_IRQn                  = 41,      /*!< There are 16 pins in total                       */
  PORT0_2_IRQn                  = 42,
  PORT0_3_IRQn                  = 43,
  PORT0_4_IRQn                  = 44,
  PORT0_5_IRQn                  = 45,
  PORT0_6_IRQn                  = 46,
  PORT0_7_IRQn                  = 47,
  PORT1_0_IRQn                  = 48,      /*!< All P1 I/O pins can be used as interrupt source. */
  PORT1_1_IRQn                  = 49,      /*!< There are 16 pins in total                       */
  PORT1_2_IRQn                  = 50,
  PORT1_3_IRQn                  = 51,
  PORT1_4_IRQn                  = 52,
  PORT1_5_IRQn                  = 53,
  PORT1_6_IRQn                  = 54,
  PORT1_7_IRQn                  = 55,
  PORT2_0_IRQn                  = 56,      /*!< All P2 I/O pins can be used as interrupt source. */
  PORT2_1_IRQn                  = 57,      /*!< There are 16 pins in total                       */
  PORT2_2_IRQn                  = 58,
  PORT2_3_IRQn                  = 59,
  PORT2_4_IRQn                  = 60,
  PORT2_5_IRQn                  = 61,
  PORT2_6_IRQn                  = 62,
  PORT2_7_IRQn                  = 63,
  PORT3_0_IRQn                  = 64,      /*!< All P3 I/O pins can be used as interrupt source. */
  PORT3_1_IRQn                  = 65,      /*!< There are 16 pins in total                       */
  PORT3_2_IRQn                  = 66,
  PORT3_3_IRQn                  = 67,
  PORT3_4_IRQn                  = 68,
  PORT3_5_IRQn                  = 69,
...
/******************************************************************************/
/** @addtogroup XST_IOT_Peripherals XST_IOT Peripherals
  XST_IOT Device Specific Peripheral registers structures
  @{
*/
...
/** @addtogroup CMSDK_TRNG CMDSK True Random Number Generator
  @{
*/
typedef struct
{
    __IO   uint32_t  RNG_IMR;         /*!< Offset: 0x100 Interrupt Mask Register  (R/W) */
    __I    uint32_t  RNG_ISR;         /*!< Offset: 0x104 Interrupt Status Register  (R/ ) */
    __O    uint32_t  RNG_ICR;         /*!< Offset: 0x108 Interrupt Clear Register ( /W) */
    __IO   uint32_t  TRNG_CONFIG;     /*!< Offset: 0x10C Configuration Register (R/W) */
    __I    uint32_t  TRNG_VALID;      /*!< Offset: 0x110 Entropy Holding Register Data Register  (R/ ) */
    __I    uint32_t  EHR_DATA[6];
    __IO   uint32_t  RND_SOURCE_ENABLE;   /*!< Offset: 0x12C Random Source Enable Register (R/W) */
    __IO   uint32_t  SAMPLE_CNT1;     /*!< Offset: 0x130 Sample Count Register  (R/W) */
    __IO   uint32_t  AUTOCORR_STATISTIC;  /*!< Offset: 0x134 Autocorrelation Register  (R/W) */
    __I    uint32_t  TRNG_DEBUG_CONTROL;  /*!< Offset: 0x138 Debug Control Register  (R/ ) */
    __IO   uint32_t  RESERVED_1;
    __O    uint32_t  TRNG_SW_RESET;   /*!< Offset: 0x140 Reset Register ( /W) */
    __IO   uint32_t  RESERVED_2[113];
    __I    uint32_t  TRNG_BUSY;       /*!< Offset: 0x1B8 Busy Register  (R/ ) */
    __O    uint32_t  RST_BITS_COUNTER;    /*!< Offset: 0x1BC Reset Bits Register ( /W) */
    __IO   uint32_t  RESERVED_3[29];
    __I    uint32_t  RNG_BIST_CNTR0;  /*!< Offset: 0x1E0 BIST Counter Register  (R/ ) */
    __I    uint32_t  RNG_BIST_CNTR1;  /*!< Offset: 0x1E4 BIST Counter Register  (R/ ) */
    __I    uint32_t  RNG_BIST_CNTR2;  /*!< Offset: 0x1E8 BIST Counter Register  (R/ ) */
} ARMTZ_TRNG_TypeDef;
/*@}*/ /* end of group CMSDK_TRNG */
...
#define CMSDK_DUALTIMER1_CTRL_PWM_Pos        8
#define CMSDK_DUALTIMER1_CTRL_PWM_Msk        (0x1ul << CMSDK_DUALTIMER1_CTRL_PWM_Pos)
...
#define CMSDK_DUALTIMER2_CTRL_PWM_Pos        8
#define CMSDK_DUALTIMER2_CTRL_PWM_Msk        (0x1ul << CMSDK_DUALTIMER2_CTRL_PWM_Pos)
...
typedef struct
{
  ...
  __IO uint32_t TimerComp;    // <h> Timer Counter Current Value <r></h>
...
typedef struct
{
  ...
  __IO   uint32_t  PULLUPSET;
  __IO   uint32_t  PULLUPCLR;
...
#define I2C_PRER_Pos                    0
#define I2C_PRER_50MHz                  (0x0063)
#define I2C_PRER_25MHz                  (0x0031)

#define I2C_CTR_EN_Pos                  7
#define I2C_CTR_EN_Msk                  (0x1UL << I2C_CTR_EN_Pos)

#define I2C_CTR_IEN_Pos                 6
#define I2C_CTR_IEN_Msk                 (0x1UL << I2C_CTR_IEN_Pos)

#define I2C_TXR_RW_bit_Pos              0
#define I2C_TXR_RW_bit_Msk              (0x1UL << I2C_TXR_RW_bit_Pos)

#define I2C_CR_STA_Pos                  7
#define I2C_CR_STA_Msk                  (0x1UL << I2C_CR_STA_Pos)

#define I2C_CR_STO_Pos                  6
#define I2C_CR_STO_Msk                  (0x1UL << I2C_CR_STO_Pos)

#define I2C_CR_RD_Pos                   5
#define I2C_CR_RD_Msk                   (0x1UL << I2C_CR_RD_Pos)

#define I2C_CR_WR_Pos                   4
#define I2C_CR_WR_Msk                   (0x1UL << I2C_CR_WR_Pos)

#define I2C_CR_ACK_Pos                  3
#define I2C_CR_ACK_Msk                  (0x1UL << I2C_CR_ACK_Pos)

#define I2C_CR_IACK_Pos                 0
#define I2C_CR_IACK_Msk                 (0x1UL << I2C_CR_IACK_Pos)

#define I2C_SR_RxACK_Pos                7
#define I2C_SR_RxACK_Msk                (0x1UL << I2C_SR_RxACK_Pos)

#define I2C_SR_Busy_Pos                 6
#define I2C_SR_Busy_Msk                 (0x1UL << I2C_SR_Busy_Pos)

#define I2C_SR_AL_Pos                   5
#define I2C_SR_AL_Msk                   (0x1UL << I2C_SR_AL_Pos)

#define I2C_SR_TIP_Pos                  1
#define I2C_SR_TIP_Msk                  (0x1UL << I2C_SR_TIP_Pos)

#define I2C_SR_IF_Pos                   0
#define I2C_SR_IF_Msk                   (0x1UL << I2C_SR_IF_Pos)
...
#define FLASH_CTRL_EXTWAITRD_Pos    0
#define FLASH_CTRL_EXTWAITRD_Msk    (0x7ul << FLASH_CTRL_EXTWAITRD_Pos)

#define FLASH_CTRL_WAITRES_Pos      3
#define FLASH_CTRL_WAITRES_Msk      (0x1ul << FLASH_CTRL_WAITRES_Pos)

#define FLASH_CTRL_EXTWAITWR_Pos    4
#define FLASH_CTRL_EXTWAITWR_Msk    (0x3ul << FLASH_CTRL_EXTWAITWR_Pos)

#define FLASH_CTRL_EXTWREN_Pos      6
#define FLASH_CTRL_EXTWREN_Msk      (0x1ul << FLASH_CTRL_EXTWREN_Pos)

#define FLASH_CTRL_EXTRSTN_Pos      7
#define FLASH_CTRL_EXTRSTN_Msk      (0x1ul << FLASH_CTRL_EXTRSTN_Pos)

#define FLASH_CTRL_INTERASE_Pos     8
#define FLASH_CTRL_INTERASE_Msk     (0x1ul << FLASH_CTRL_INTERASE_Pos)

#define FLASH_CTRL_INTNVR_Pos       9
#define FLASH_CTRL_INTNVR_Msk       (0x1ul << FLASH_CTRL_INTNVR_Pos)

#define FLASH_CTRL_INTINIT_Pos      11
#define FLASH_CTRL_INTINIT_Msk      (0x1ul << FLASH_CTRL_INTINIT_Pos)

#define FLASH_CTRL_INTERTR_Pos      12
#define FLASH_CTRL_INTERTR_Msk      (0x1ul << FLASH_CTRL_INTERTR_Pos)

#define FLASH_STAT_EXTRY_Pos        0
#define FLASH_STAT_EXTRY_Msk        (0x1ul << FLASH_STAT_EXTRY_Pos)
                                
#define FLASH_STAT_EXTREADY_Pos     1
#define FLASH_STAT_EXTREADY_Msk     (0x1ul << FLASH_STAT_EXTREADY_Pos)
                                
#define FLASH_STAT_INTREADY_Pos    2
#define FLASH_STAT_INTREADY_Msk    (0x1ul << FLASH_STAT_INTREADY_Pos)

#define FLASH_STAT_FLCFG_Pos        3
#define FLASH_STAT_FLCFG_Msk        (0x1ul << FLASH_STAT_FLCFG_Pos)

/* --- End of Flash Control and Status Register --- */
...
typedef struct {
    ...
    __IO uint8_t  RTCITCR;
         uint8_t  RESERVED6[3];
    __IO uint8_t  RTCITOP;
         uint8_t  RESERVED7[3];
    __IO uint32_t RTCTOFFSET;
    __IO uint32_t RTCTCOUNT;
} RTC_TypeDef;
#else
typedef struct {
	__IO uint32_t RRTC_TIME;
	__IO uint32_t RRTC_DATE;
	__IO uint32_t RRTC_TALRM;
	__IO uint32_t RRTC_DALRM;
	__IO uint32_t RRTC_CTRL;
	__IO uint32_t RRTC_RST;
} RTC_TypeDef;
#endif
...
#define XSTIOT_SPI_SPIE_Pos    7
#define XSTIOT_SPI_SPIE_Msk    (1 << XSTIOT_SPI_SPIE_Pos)

#define XSTIOT_SPI_SPE_Pos     6
#define XSTIOT_SPI_SPE_Msk     (1 << XSTIOT_SPI_SPE_Pos)

#define XSTIOT_SPI_MSTR_Pos    4
#define XSTIOT_SPI_MSTR_Msk    (1 << XSTIOT_SPI_MSTR_Pos)

#define XSTIOT_SPI_CPOL_Pos    3
#define XSTIOT_SPI_CPOL_Msk    (1 << XSTIOT_SPI_CPOL_Pos)

#define XSTIOT_SPI_CPHA_Pos    2
#define XSTIOT_SPI_CPHA_Msk    (1 << XSTIOT_SPI_CPHA_Pos)

#define XSTIOT_SPI_SPR_Pos     0
#define XSTIOT_SPI_SPR_Msk     (3 << XSTIOT_SPI_SPR_Pos)

#define XSTIOT_SPI_SPIF_Pos    7
#define XSTIOT_SPI_SPIF_Msk    (1 << XSTIOT_SPI_SPIF_Pos)

#define XSTIOT_SPI_WCOL_Pos    6
#define XSTIOT_SPI_WCOL_Msk    (1 << XSTIOT_SPI_WCOL_Pos)

#define XSTIOT_SPI_WFFULL_Pos  3
#define XSTIOT_SPI_WFFULL_Msk  (1 << XSTIOT_SPI_WFFULL_Pos)

#define XSTIOT_SPI_WFEMPTY_Pos 2
#define XSTIOT_SPI_WFEMPTY_Msk (1 << XSTIOT_SPI_WFEMPTY_Pos)

#define XSTIOT_SPI_RFFULL_Pos  1
#define XSTIOT_SPI_RFFULL_Msk  (1 << XSTIOT_SPI_RFFULL_Pos)

#define XSTIOT_SPI_RFEMPTY_Pos 0
#define XSTIOT_SPI_RFEMPTY_Msk (1 << XSTIOT_SPI_RFEMPTY_Pos)

#define XSTIOT_SPI_ICNT_Pos    6
#define XSTIOT_SPI_ICNT_Msk    (3 << XSTIOT_SPI_ICNT_Pos)

#define XSTIOT_SPI_ESPR_Pos    0
#define XSTIOT_SPI_ESPR_Msk    (3 << XSTIOT_SPI_ESPR_Pos)

/* --- End of Serial Peripheral Interface (SPI) --- */
...
#define XSTIOT_DES_START_Pos   0
#define XSTIOT_DES_START_Msk   (1<<XSTIOT_DES_START_Pos)

#define XSTIOT_DES_INSKEY_Pos  1
#define XSTIOT_DES_INSKEY_Msk  (1<<XSTIOT_DES_INSKEY_Pos)

#define XSTIOT_DES_DECRYPT_Pos 2
#define XSTIOT_DES_DECRYPT_Msk (1<<XSTIOT_DES_DECRYPT_Pos)

#define XSTIOT_DES_STATUS_Pos  0
#define XSTIOT_DES_STATUS_Msk  (1<<XSTIOT_DES_STATUS_Pos)

/* --- End of Data Encryption Standard (DES) --- */
...
#define XSTIOT_AES_KEYSIZE_Pos 3
#define XSTIOT_AES_KEYSIZE_Msk (1<<XSTIOT_AES_KEYSIZE_Pos)

#define XSTIOT_AES_MODE_Pos    2
#define XSTIOT_AES_MODE_Msk    (1<<XSTIOT_AES_MODE_Pos)

#define XSTIOT_AES_INSKEY_Pos  1
#define XSTIOT_AES_INSKEY_Msk  (1<<XSTIOT_AES_INSKEY_Pos)

#define XSTIOT_AES_START_Pos   0
#define XSTIOT_AES_START_Msk   (1<<XSTIOT_AES_START_Pos)

/* --- End of Advanced Encryption Standard (AES) -- */
...
typedef struct {
	...
	__I  uint32_t HWPARAMS;
	__IO uint32_t CSHR;
	__IO uint32_t CSMR;
} CMSDK_CACHE_TypeDef;

#define CMSDK_CACHE_CCR_STATISTIC_EN_Pos         6                                             /*!< */
#define CMSDK_CACHE_CCR_STATISTIC_EN_Msk         (0x1UL << CMSDK_CACHE_CCR_STATISTIC_EN_Pos)   /*!< */

#define CMSDK_CACHE_CCR_SET_PREFETCH_Pos         5                                             /*!< */
#define CMSDK_CACHE_CCR_SET_PREFETCH_Msk         (0x1UL << CMSDK_CACHE_CCR_SET_PREFETCH_Pos)   /*!< */

#define CMSDK_CACHE_CCR_SET_MAN_INV_Pos          4                                             /*!< */
#define CMSDK_CACHE_CCR_SET_MAN_INV_Msk          (0x1UL << CMSDK_CACHE_CCR_SET_MAN_INV_Pos)    /*!< */

#define CMSDK_CACHE_CCR_SET_MAN_POW_Pos          3                                             /*!< */
#define CMSDK_CACHE_CCR_SET_MAN_POW_Msk          (0x1UL << CMSDK_CACHE_CCR_SET_MAN_POW_Pos)    /*!< */

#define CMSDK_CACHE_CCR_POW_REQ_Pos              2                                             /*!< */
#define CMSDK_CACHE_CCR_POW_REQ_Msk              (0x1UL << CMSDK_CACHE_CCR_POW_REQ_Pos)        /*!< */

#define CMSDK_CACHE_CCR_INV_REQ_Pos              1                                             /*!< */
#define CMSDK_CACHE_CCR_INV_REQ_Msk              (0x1UL << CMSDK_CACHE_CCR_INV_REQ_Pos)        /*!< */

#define CMSDK_CACHE_CCR_EN_Pos                   0                                             /*!< */
#define CMSDK_CACHE_CCR_EN_Msk                   (0x1UL << CMSDK_CACHE_CCR_EN_Pos)             /*!< */

#define CMSDK_CACHE_SR_POW_STAT_Pos              4                                             /*!< */
#define CMSDK_CACHE_SR_POW_STAT_Msk              (0x1UL << CMSDK_CACHE_SR_POW_STAT_Pos)        /*!< */

#define CMSDK_CACHE_SR_INV_STAT_Pos              2                                             /*!< */
#define CMSDK_CACHE_SR_INV_STAT_Msk              (0x1UL << CMSDK_CACHE_SR_INV_STAT_Pos)        /*!< */

#define CMSDK_CACHE_SR_CS_Pos                    0                                             /*!< */
#define CMSDK_CACHE_SR_CS_Msk                    (0x3UL << CMSDK_CACHE_SR_CS_Pos)              /*!< */

#define CMSDK_CACHE_IRQMASK_MAN_INV_ERR_Pos      1                                             /*!< */
#define CMSDK_CACHE_IRQMASK_MAN_INV_ERR_Msk      (0x1UL << CMSDK_CACHE_IRQMASK_MAN_INV_ERR_Pos)/*!< */

#define CMSDK_CACHE_IRQMASK_POW_ERR_Pos          0                                             /*!< */
#define CMSDK_CACHE_IRQMASK_POW_ERR_Msk          (0x1UL << CMSDK_CACHE_IRQMASK_POW_ERR_Pos)    /*!< */

#define CMSDK_CACHE_IRQSTAT_MAN_INV_ERR_Pos      1                                             /*!< */
#define CMSDK_CACHE_IRQSTAT_MAN_INV_ERR_Msk      (0x1UL << CMSDK_CACHE_IRQSTAT_MAN_INV_ERR_Pos)/*!< */

#define CMSDK_CACHE_IRQSTAT_POW_ERR_Pos          0                                             /*!< */
#define CMSDK_CACHE_IRQSTAT_POW_ERR_Msk          (0x1UL << CMSDK_CACHE_IRQSTAT_POW_ERR_Pos)    /*!< */

#define CMSDK_CACHE_HWPARAMS_GEN_STAT_LOGIC_Pos  13                                                /*!< */
#define CMSDK_CACHE_HWPARAMS_GEN_STAT_LOGIC_Msk  (0x1UL << CMSDK_CACHE_HWPARAMS_GEN_STAT_LOGIC_Pos)/*!< */

#define CMSDK_CACHE_HWPARAMS_RESET_ALL_REGS_Pos  12                                                /*!< */
#define CMSDK_CACHE_HWPARAMS_RESET_ALL_REGS_Msk  (0x1UL << CMSDK_CACHE_HWPARAMS_RESET_ALL_REGS_Pos)/*!< */

#define CMSDK_CACHE_HWPARAMS_CACHE_WAY_Pos       10                                                /*!< */
#define CMSDK_CACHE_HWPARAMS_CACHE_WAY_Msk       (0x3UL << CMSDK_CACHE_HWPARAMS_CACHE_WAY_Pos)     /*!< */

#define CMSDK_CACHE_HWPARAMS_CW_Pos              5                                                 /*!< */
#define CMSDK_CACHE_HWPARAMS_CW_Msk              (0x1FUL << CMSDK_CACHE_HWPARAMS_CW_Pos)           /*!< */

#define CMSDK_CACHE_HWPARAMS_AW_Pos              0                                                 /*!< */
#define CMSDK_CACHE_HWPARAMS_AW_Msk              (0x1FUL << CMSDK_CACHE_HWPARAMS_AW_Pos)           /*!< */

/* --- End of FLASH CACHE (CACHE) -- */

#if defined ( __CC_ARM   )
#pragma no_anon_unions
#endif

/*@}*/ /* end of group XST_IOT_Peripherals */

/******************************************************************************/
/*                         Peripheral memory map                              */
/******************************************************************************/
/** @addtogroup XST_IOT_MemoryMap XST_IOT Memory Mapping
  @{
*/
...
#define FLASHCTRL_BASE          (CMSDK_APB_BASE + 0x3000UL)
...
#define ARMTZ_TRNG_BASE         (CMSDK_APB_BASE + 0x7100UL)
#define CMSDK_WATCHDOG_BASE     (CMSDK_APB_BASE + 0x8000UL)
#define RTC_BASE                (CMSDK_APB_BASE + 0x9000UL)
#define XSTIOT_DES_BASE         (CMSDK_APB_BASE + 0xA000UL)
#define XSTIOT_SPI_BASE         (CMSDK_APB_BASE + 0xD000UL)
#define I2C0_BASE               (CMSDK_APB_BASE + 0xE000UL)
//#define CMSDK_PL230_BASE        (CMSDK_APB_BASE + 0xF000UL)
#define XSTIOT_AES_BASE         (CMSDK_APB_BASE + 0xF000UL)
#define XSTIOT_CLKCON_BASE      (CMSDK_APB_BASE + 0xDC00UL)
#define CMSDK_CACHE_BASE        (CMSDK_APB_BASE + 0x3400UL)
...
#define CMSDK_GPIO4_BASE        (CMSDK_AHB_BASE + 0x4000UL)
#define CMSDK_GPIO5_BASE        (CMSDK_AHB_BASE + 0x5000UL)
#define CMSDK_GPIO6_BASE        (CMSDK_AHB_BASE + 0x6000UL)
#define CMSDK_GPIO7_BASE        (CMSDK_AHB_BASE + 0x7000UL)
#define CMSDK_GPIO8_BASE        (CMSDK_AHB_BASE + 0x8000UL)
#define CMSDK_GPIO9_BASE        (CMSDK_AHB_BASE + 0x9000UL)
#define CMSDK_SYSCTRL_BASE      (CMSDK_AHB_BASE + 0xF000UL)
/*@}*/ /* end of group XST_IOT_MemoryMap */


/******************************************************************************/
/*                         Peripheral declaration                             */
/******************************************************************************/
/** @addtogroup XST_IOT_PeripheralDecl XST_IOT Peripheral Declaration
  @{
*/
...
#define ARMTZ_TRNG              ((ARMTZ_TRNG_TypeDef   *) ARMTZ_TRNG_BASE   )
...
#define CMSDK_GPIO6             ((CMSDK_GPIO_TypeDef   *) CMSDK_GPIO6_BASE   )
#define CMSDK_GPIO7             ((CMSDK_GPIO_TypeDef   *) CMSDK_GPIO7_BASE   )
#define CMSDK_GPIO8             ((CMSDK_GPIO_TypeDef   *) CMSDK_GPIO8_BASE   )
#define CMSDK_GPIO9             ((CMSDK_GPIO_TypeDef   *) CMSDK_GPIO9_BASE   )
#define CMSDK_SYSCON            ((CMSDK_SYSCON_TypeDef *) CMSDK_SYSCTRL_BASE )
#define I2C0                    ((I2C_TypeDef          *) I2C0_BASE          )
#define FLASHCTRL               ((FLASHCTRL_TypeDef    *) FLASHCTRL_BASE     )
#define RTC                     ((RTC_TypeDef          *) RTC_BASE           )
#define XSTIOT_SPI              ((SPI_TypeDef          *) XSTIOT_SPI_BASE    )
#define XSTIOT_DES              ((XSTIOT_DES_TypeDef   *) XSTIOT_DES_BASE    )
#define XSTIOT_AES              ((XSTIOT_AES_TypeDef   *) XSTIOT_AES_BASE    )
#define XSTIOT_CLKCON           (*(volatile uint32_t   *) XSTIOT_CLKCON_BASE )
#define CMSDK_CACHE             ((CMSDK_CACHE_TypeDef  *) CMSDK_CACHE_BASE   )

/*@}*/ /* end of group XST_IOT_PeripheralDecl */

/*@}*/ /* end of group XST_IOT_Definitions */
